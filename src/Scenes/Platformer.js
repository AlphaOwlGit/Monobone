class Platformer extends Phaser.Scene {
    ...
    init() {
        ...
        this.DRAG = 550;    // DRAG < ACCELERATION = icy slide
    ...
    create() {
        ...
        my.sprite.player = this.physics.add.sprite(30, 30, "platformer_characters", "tile_0340.png");
        ...
        this.physics.add.collider(my.sprite.player, this.groundLayer);
         ...
         this.physics.add.overlap(my.sprite.player, this.coinGroup, (obj1, obj2) => {
            ...
            this.coinAmount++;
            if (this.coinAmount == this.coinTotal) {
